...
基于微信云开发的旅行路线规划小程序，支持自然语言输入，智能生成个性化行程并配图。

## 功能

- **智能分析**：输入旅行想法，自动提取目的地、天数、预算、偏好
...
- 微信小程序原生 + 云开发
- 智能服务：`wx.cloud.extend.AI`（混元 hunyuan-t1）
...
- 需开通 **智能服务扩展** 以使用 `wx.cloud.extend.AI`
